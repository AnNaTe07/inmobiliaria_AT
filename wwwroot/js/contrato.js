...
function anular(id, direccion, propietario, inquilino) {
  ...
  document.querySelector("#contrato_anular_direccion").innerText =
    "Dirección: " + direccion;
  document.querySelector("#contrato_anular_propietario").innerText =
    "Propietario: " + propietario;
  document.querySelector("#contrato_anular_inquilino").innerText =
    "Inquilino: " + inquilino;

  $("#modal_anular_contrato").modal("show");
}
function eliminar(id, direccion, propietario, inquilino) {
  document.querySelector("#contrato_eliminar_id").value = id;
  document.querySelector("#contrato_eliminar_direccion").innerText =
    "Dirección: " + direccion;
  document.querySelector("#contrato_eliminar_propietario").innerText =
    "Propietario: " + propietario;
  document.querySelector("#contrato_eliminar_inquilino").innerText =
    "Inquilino: " + inquilino;
